...
Engine features exercised: @page margin boxes with counter(page)/counter(pages), border-collapse tables, flexbox with flex: 1 columns, absolute positioning for the full-bleed head rule.
