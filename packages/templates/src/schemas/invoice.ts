...
export const invoiceSchema = z.object({
  ...
  items: z.array(z.object({
    ...
    quantity: z.number(),
    unitPrice: z.number(),
    discount: z.number().optional().describe('Line discount as decimal, e.g. 0.1 for 10%'),
  })).describe('Line items'),
...
export const invoiceFields: Record<string, string> = {
  ...
  items: 'array - line items with description, quantity, unitPrice, optional discount (decimal)',
...
export const invoiceExample: InvoiceData = {
  ...
  items: [
    ...
    { description: 'Social Media Templates - Instagram, LinkedIn, Twitter (12 templates)', quantity: 12, unitPrice: 125.00, discount: 0.15 },
    { description: 'Brand Guidelines Document - 24-page PDF with usage rules', quantity: 1, unitPrice: 1800.00, discount: 0.1 },
    { description: 'Print Collateral - trifold brochure, 2-sided flyer, poster set', quantity: 3, unitPrice: 700.00 },
    { description: 'Motion Graphics - animated logo sting and lower-third pack', quantity: 1, unitPrice: 2400.00 },
    { description: 'Photography Art Direction - half-day shoot supervision and retouching', quantity: 2, unitPrice: 950.00, discount: 0.05 },
    { description: 'Email Template System - responsive HTML for newsletter and transactional', quantity: 4, unitPrice: 400.00 },
    { description: 'Presentation Deck Template - 30 master slides, Keynote and PowerPoint', quantity: 1, unitPrice: 1650.00 },
    { description: 'Signage and Wayfinding - lobby wall, door plaques, directory board', quantity: 1, unitPrice: 2900.00 },
    { description: 'Packaging Design - mailer box, tissue wrap, sticker set', quantity: 3, unitPrice: 800.00 },
    { description: 'Icon Set - 48 custom line icons, SVG and webfont delivery', quantity: 48, unitPrice: 45.00, discount: 0.2 },
    { description: 'Copywriting - homepage, services, and about page narrative', quantity: 1, unitPrice: 1400.00 },
    { description: 'Style Guide Workshop - half-day session with the marketing team', quantity: 1, unitPrice: 1200.00 },
    { description: 'Vehicle Wrap Design - two van livery variants, print-ready', quantity: 2, unitPrice: 1100.00 },
    { description: 'Trade Show Booth Graphics - 10ft backwall, banner stands, table runner', quantity: 1, unitPrice: 3200.00, discount: 0.1 },
    { description: 'Accessibility Audit - WCAG 2.2 AA review of the new site', quantity: 1, unitPrice: 1750.00 },
    { description: 'Photography Licensing - 12-month commercial usage, 20 images', quantity: 20, unitPrice: 60.00 },
  ],
