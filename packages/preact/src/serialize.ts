import { type VNode, type ComponentChild, isValidElement, toChildArray, Fragment } from 'preact';

// Compat aliases so the ported serialize body stays identical to @formepdf/react.
type ReactElement = VNode;
type ReactNode = ComponentChild;
const Children = {
  forEach<T>(children: T, cb: (child: ReactNode) => void): void {
    toChildArray(children as ComponentChild).forEach((c) => cb(c as ReactNode));
  },
};
// eslint-disable-next-line @typescript-eslint/no-namespace
declare namespace React { type ReactNode = ComponentChild; }
...
export function serialize(element: ReactElement): FormeDocument {
  ...
  const props = element.props as any as DocumentProps & { children?: unknown };
...
function serializeChild(child: unknown, parent: ParentContext = null): FormeNode | null {
  ...
  if (isDocumentType(element.type)) {
    ...
    const props = element.props as any as { children?: unknown };
    const childElements = flattenChildren(props.children);
...
function serializeView(element: ReactElement, _parent: ParentContext = null): FormeNode {
  const props = element.props as any as { style?: Style; wrap?: boolean; bookmark?: string; href?: string; children?: unknown };
...
function serializeImage(element: ReactElement): FormeNode {
  const props = element.props as any as { src: string; width?: number; height?: number; style?: Style; href?: string; alt?: string };
...
function serializeTable(element: ReactElement, _parent: ParentContext = null): FormeNode {
  const props = element.props as any as { columns?: ColumnDef[]; style?: Style; children?: unknown };
...
function serializeRow(element: ReactElement): FormeNode {
  const props = element.props as any as { header?: boolean; style?: Style; children?: unknown };
  const childElements = flattenChildren(props.children);
...
function serializeCell(element: ReactElement): FormeNode {
  const props = element.props as any as { colSpan?: number; rowSpan?: number; style?: Style; children?: unknown };
  const childElements = flattenChildren(props.children);
...
function serializeFixed(element: ReactElement): FormeNode {
  const props = element.props as any as { position: 'header' | 'footer'; style?: Style; bookmark?: string; children?: unknown };
...
function serializeSvg(element: ReactElement): FormeNode {
  const props = element.props as any as { width: number; height: number; viewBox?: string; content?: string; style?: Style; href?: string; alt?: string; children?: ReactNode };
...
function serializeQrCode(element: ReactElement): FormeNode {
  const props = element.props as any as QrCodeProps;
...
function serializeBarcode(element: ReactElement): FormeNode {
  const props = element.props as any as BarcodeProps;
  const kind: FormeNodeKind = {
    type: 'Barcode',
    data: props.data,
...
function serializeTextField(element: ReactElement): FormeNode {
  const props = element.props as any as TextFieldProps;
  const kind: FormeNodeKind = {
    type: 'TextField',
    name: props.name,
    width: props.width,
...
function serializeCheckbox(element: ReactElement): FormeNode {
  const props = element.props as any as CheckboxProps;
  const kind: FormeNodeKind = {
    type: 'Checkbox',
    name: props.name,
...
function serializeDropdown(element: ReactElement): FormeNode {
  const props = element.props as any as DropdownProps;
  const kind: FormeNodeKind = {
    type: 'Dropdown',
    name: props.name,
...
function serializeRadioButton(element: ReactElement): FormeNode {
  const props = element.props as any as RadioButtonProps;
  const kind: FormeNodeKind = {
    type: 'RadioButton',
    name: props.name,
    value: props.value,
...
function serializeCanvas(element: ReactElement): FormeNode {
  const props = element.props as any as CanvasProps;
...
function serializeWatermark(element: ReactElement): FormeNode {
  const props = element.props as any as WatermarkProps;
...
function serializeBarChart(element: ReactElement): FormeNode {
  const props = element.props as any as BarChartProps;
  return {
...
function serializeLineChart(element: ReactElement): FormeNode {
  const props = element.props as any as LineChartProps;
  return {
...
function serializePieChart(element: ReactElement): FormeNode {
  const props = element.props as any as PieChartProps;
  return {
...
function serializeAreaChart(element: ReactElement): FormeNode {
  const props = element.props as any as AreaChartProps;
  return {
...
function serializeDotPlot(element: ReactElement): FormeNode {
  const props = element.props as any as DotPlotProps;
  return {
...
export function serializeTemplate(element: ReactElement): Record<string, unknown> {
  ...
  const props = element.props as any as { title?: string; author?: string; subject?: string; creator?: string; children?: unknown } & DocumentProps;
...
function serializeTemplatePage(element: ReactElement): Record<string, unknown> {
  const props = element.props as any as { size?: string | { width: number; height: number }; margin?: number | string | number[] | Edges; children?: unknown };
...
function serializeTemplateImage(element: ReactElement): Record<string, unknown> {
  const props = element.props as any as { src: string | unknown; width?: number; height?: number; style?: Style };
