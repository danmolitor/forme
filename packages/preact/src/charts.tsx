 ...
 * ```
 */
export function LegacyBarChart(props: LegacyBarChartProps): VNode<any> {
  const {
    width, height, data,
    color = '#1a365d',
    barGap = 4,
  ...
  if (data.length === 0) {
    return h(View, { style: { width, height, ...props.style } });
  }
  ...
  return h(View, {
    ...
    h(Svg, { width, height, viewBox, content: svg }),
    ...labels,
  );
}
 ...
 * ```
 */
export function LegacyLineChart(props: LegacyLineChartProps): VNode<any> {
  const {
    width, height, data,
    color = '#2b6cb0',
    strokeWidth = 2,
 ...
 * ```
 */
export function LegacyPieChart(props: LegacyPieChartProps): VNode<any> {
  const {
    width, height, data,
    showLabels = false,
    innerRadius = 0,
