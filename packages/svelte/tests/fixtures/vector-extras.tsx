import type { CanvasContext } from '@formepdf/react';
import { Document, Page, View, Text, Canvas, Watermark, PageBreak } from '@formepdf/react';

export interface Props {
  accent?: [number, number, number];
}

/** TSX twin of vector-extras.svelte for cross-adapter parity tests. */
export default function VectorExtrasFixture({ accent = [59, 130, 246] }: Props) {
  ...
  return (
    <Document title="Vector Extras Parity">
      <Page size="A4" margin={40}>
        ...
        <Canvas width={200} height={110} draw={draw} style={{ marginBottom: 8 }} />
        <PageBreak />
