import type { ChartDataPoint, ChartSeries, DotPlotGroup } from '@formepdf/react';
import {
  Document,
  Page,
  View,
...
/** TSX twin of charts.svelte for cross-adapter parity tests. */
export default function ChartsFixture({ highlight = '#ef4444' }: Props) {
  ...
  const doseResponse: DotPlotGroup[] = [
